    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-5 pt-0 md:pt-5">
      ...
      <div className="bg-gray-800 p-5 rounded-lg shadow-lg w-full max-w-4xl mb-5 text-white">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>CodeAlpha (July - Sept 2024)<br />Online<br />– Built and optimized Python-based projects, enhancing problem-solving and algorithmic skills.<br />– Developed automation scripts and small web applications.</li>
      ...
      <div className="bg-gray-800 p-5 rounded-lg shadow-lg w-full max-w-4xl mb-5 text-white">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>First Place in Python PDF Password Cracking Competition<br />Demonstrated expertise in Python scripting, cryptography, and ethical hacking concepts.</li>
          <li>Completed AI Essentials by Google<br />Learned key AI concepts and their applications in various domains.</li>
        </ul>
      </div>
    </div>
  );
