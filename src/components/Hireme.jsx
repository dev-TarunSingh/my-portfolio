...
const gigs = [
  {
    ...
    description: 'I will maintain, develop all types of website with react and wordpress',
    link: 'https://www.fiverr.com/s/Q7GPoWe',
    image: WebGig
  },
  {
    title: 'React Native App Development',
    description: 'Get a professional mobile app for Android and iOS using React Native & Expo with backend integration.',
  ...
  },
  {
    ...
    description: 'I can also help you with your projects in Python, Java, and C++ or Some custom projects. ',
    link: "/contact",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {gigs.map((gig, index) => (
            <div key={index} className="bg-gray-800 p-5 rounded-4xl shadow-lg flex flex-col">
              <div className="aspect-[4/3] mb-5"> {/* Custom aspect ratio 4:3 */}
                <img
